...
class World(DirectObject):
  def __init__(self):
    ...
    self.torus = loader.loadModel('platform-L.egg')
    self.torus.reparentTo(floor)        
    #for y in range(6):
      #for x in range(8):
    ...
    self.torus.reparentTo(render)
    self.torus.setPos(0,-20,15)
    ...
    self.Light=self.LCam.attachNewNode(DirectionalLight("Light"))
