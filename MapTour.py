...
from FlyCamera import FlyCamera
...
class MapTour( object ):
    ...
    def initFlyCamera( self ):
        """ loads the player and creates all the controls for him"""
        self.flyCamera = FlyCamera( self )
        self.flyCamera.flyCamera.setPos(-34.0,30.0,3.0)
        #self.player.player.setPos(32.0,-31.0,10.0)
    ...
    def addTasks( self ):
        taskMgr.add( self.messageUpdate, 'MessageTask' )
        self.timerTask = taskMgr.add( self.timer, 'TimerTask' )
        taskMgr.add( self.flyCamera.mouseUpdate, 'MouseTask' )
        taskMgr.add( self.flyCamera.moveUpdate,  'MoveTask'  )
