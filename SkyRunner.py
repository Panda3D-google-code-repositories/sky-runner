...
#class State ( object ):
#    MAINMENU, CREDITSMENU, INGAME, INGAMEMENU, INGAMECREDITSMENU = range(5)
    
    
class SkyRunner(DirectObject.DirectObject): #Class for main menu
    ...
    def showInGameMenu(self): #Function that show credits
